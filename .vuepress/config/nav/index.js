module.exports = {
  zh: [
    ...
    {
      text: "案例",
      link: "/views/other/theme-example.html",
      icon: "reco-category",
    },
    {
      text: "订阅",
    ...
    {
      text: "留言板",
      link: "/views/other/messageBoard.html",
      icon: "reco-suggestion",
    },
    {
      text: "GitHub",
      link: "https://github.com/vuepress-reco/vuepress-theme-reco-1.x",
      icon: "reco-github",
    },
  ],
  en: [
    {
      ...
      items: [
        {
          text: "Theme",
          items: [{ text: "1.x", link: "/en/views/1.x/" }],
        },
        {
          text: "Plugin",
          items: [{ text: "plugin", link: "/en/views/plugins/" }],
        },
      ],
    },
    ...
    {
      text: "Examples",
      link: "/en/views/other/theme-example.html",
      icon: "reco-category",
    },
    {
      text: "RSS",
